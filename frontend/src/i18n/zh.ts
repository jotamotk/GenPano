export const zh = {
  ...
  login: {
    ...
    signUp: '注册',
    emailLabel: '邮箱',
    emailPlaceholder: '邮箱，例如：name@example.com',
    continueButton: '继续',
    forgotPassword: '忘记密码？',
    ...
    editEmail: '修改邮箱',
    noAccountHint: '点击继续后，未注册的邮箱将自动跳转至注册页',
  },
  ...
  emailSent: {
    verifyTitle: '请查收邮箱',
    verifySubtitle: '验证邮件已发送。完成验证后即可继续设置账号。',
    resetTitle: '请查收邮箱',
    resetSubtitle: '若该邮箱已注册，系统将发送密码重置邮件。',
    sentTo: 'Sent to',
    sentToZh: '已发送至',
  ...
  forgotPassword: {
    ...
    noAccount: '没有账号？',
    signUp: '注册',
    description: '输入注册邮箱，系统将发送密码重置链接',
