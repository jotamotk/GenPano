...
# a dedicated module (retry_via_vm.py) to keep the existing retry
# handler untouched (Issue #1144 Forbidden Scope) and to keep
# Playwright/CDP-touching code off the import path of the read-only
# stats router.
