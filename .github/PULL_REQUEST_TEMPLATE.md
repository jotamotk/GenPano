...
- [ ] PRD Coverage matches the linked issue's Acceptance Criteria when product behavior is involved.
- [ ] Required verification evidence is present or explicitly blocked.
