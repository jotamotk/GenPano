...
# /api/users/* admin routes migrated to FastAPI in Phase 3 — see
# backend/app/api/admin/users/router.py. admin.html now calls the absolute
# path /api/admin/users/* directly (bypassing the legacy /admin/api/users
# nginx route through this Flask service).
