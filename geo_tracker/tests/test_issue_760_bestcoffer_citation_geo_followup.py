...
APPROVAL_REF = (
    ...
    "AI Lead approved production writes for BestCoffer citation GEO materialization apply"
)
...
@pytest.mark.parametrize(
    ...
    [
        "",
        "https://github.com/jotamotk/trash_test/issues/760#issuecomment-4439507284 dry-run only",
